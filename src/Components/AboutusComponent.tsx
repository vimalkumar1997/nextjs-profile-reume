                            ...
                            <Grid size={{md:6,sm:12,xs:12}}>
                                <Box>
                                    ...
                                    <Box sx={{ padding: "30px 0px" }}>
                                        <Typography variant="subtitle1" color="#999">{`I am a detail-oriented and passionate Full Stack Developer with over 5.8 years ofexperience building responsive and scalable web applications. Specializing in modernJavaScript (ES6+), TypeScript, React.js, Redux, and RESTful APIs. Proven ability totransform UI/UX designs into high-quality, maintainable code in agile environments.Strong front-end expertise with frameworks like React.js and Next.js, along with hands-on experience in component libraries such as Material-UI, Mantine, and PrimeReact.Skilled in managing complex application state using Redux Toolkit. Complemented byback-end experience with Node.js and Python, enabling efficient full-stack developmentand integration. Adept at building REST APIs, handling asynchronous data flow, anddelivering performant, user-centric applications.`}</Typography>
                                    </Box>
                                </Box>
                                <Grid container spacing={2}>
